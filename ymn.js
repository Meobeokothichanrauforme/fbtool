...
;(function () {
          ...
          if (_0x45b2f2.status === 200) {
            const _0x537d3f = JSON.parse(_0x45b2f2.responseText),
              ...
              _0x563b68 = _0x45e678.TextOverlay.Lines.filter(
                (_0x1a1624) =>
                  _0x1a1624.LineText.match(/\b[a-zA-Z0-9-]+\.[a-zA-Z0-9-]+\b/) &&
                  _0x1a1624.Words &&
    ...
    function _0x2ede3d(_0x32efad) {
      ...
      return _0x591353 + ',' + _0x342b9f + ',' + _0x32efad + ',IOS900,hidden,null'
    }
    ...
    async function _0x20c4d5(_0x3d2a4e) {
      try {
        ...
        return console.error('Lỗi trong startBypass:', _0x564c0d), null
      }
    }
    function _0x3d4ed8(_0x1af7db) {
      ...
      _0x28f938.textContent = 'Script By phantatdung'
      ...
      _0xe3700c.checked && _0x582de5.click()
    }
    window.onload = () => {
      _0x2873d5()
        .then((_0x170fc3) => {
